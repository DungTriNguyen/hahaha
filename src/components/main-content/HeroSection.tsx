    ...
    <>
      ...
      <section className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10 gap-9">
          ...
          <div className="relative z-50 bg-[#2468FF] rounded-2xl flex items-center gap-8 p-2 overflow-hidden group cursor-pointer">
            <p className="ml-6">EXPLORE NOW</p>

            {/* Container cho icon */}
            <div className="p-3 rounded-lg bg-[#1A4CD8] relative w-10 h-10 overflow-hidden">
              {/* Icon mặc định (starts.svg) */}
              <div className="absolute inset-0 flex items-center justify-center transition-all duration-300 ease-in-out group-hover:translate-x-full group-hover:opacity-0">
                <Image src="/starts.svg" alt="starts" width={26} height={26} />
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center transition-all duration-300 ease-in-out translate-x-[-100%] opacity-0 group-hover:translate-x-0 group-hover:opacity-100">
                <Image src="/right.svg" alt="arrow" width={8} height={16} />
              </div>
            </div>
          </div>
        </div>

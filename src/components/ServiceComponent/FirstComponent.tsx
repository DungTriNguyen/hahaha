...
const FirstComponent = () => {
  return (
    <section className="relative overflow-hidden bg-[#0C0B10] text-white pt-20 md:pt-32 lg:pt-44 pb-10 md:pb-16 lg:pb-20">
      {/* Sóng động background */}
      <div className="relative z-20 pointer-events-none">
        <div className="absolute top-0 left-0 w-full z-20 pointer-events-none">
          <div
            className=" h-full w-[100%] smooth-animate-wave1"
            style={{ backgroundImage: 'url("/vector 4.svg")' }}
          ></div>
          <div
            className=" h-full w-[100%]  smooth-animate-wave2"
            style={{ backgroundImage: 'url("/vector 5.svg")' }}
          ></div>
          <div
            className="h-full w-[100%] smooth-animate-wave3"

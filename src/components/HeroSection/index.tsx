    ...
    <>
      ...
      <section className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
          ...
          <div className="bg-button rounded-lg flex items-center gap-8 p-2">
            <p className="ml-6">EXPLORE NOW</p>
            <div className="p-3 rounded-lg bg-numberCard">
              <Image src="/start.svg" alt="logo" width={26} height={26} />
              <Image src="/right.svg" alt="logo" width={8} height={16} />
            </div>
          </div>
        </div>
      </section>

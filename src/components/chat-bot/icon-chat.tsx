...
const IconChat = () => {
    return (
        <div className="fixed bottom-4 right-4 flex flex-col gap-4 z-50">
            <Link href={'/'}><div className="flex items-center justify-end group relative">
                ...
                <button
                    className="group p-2 md:p-3 rounded-lg md:rounded-xl bg-[#2468FF] border-4 border-[#1A4CD8] relative lg:w-[64px] lg:h-[64px] md:w-[56px] md:h-[56px] overflow-hidden transition-colors duration-300"
            ...
            <Link href={'/contact'}><div className="flex items-center justify-end group relative">
